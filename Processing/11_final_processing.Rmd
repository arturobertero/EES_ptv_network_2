...
p_load(tidyverse, here, haven, countrycode, vdemdata, psych, lavaan, ltm, magick,
       ...
       hrbrthemes, viridis, ggrepel, jtools, patchwork, kableExtra, bootnet, qgraph)
...
#save
ggsave(here("Output", "Article", "Figure_2.jpg"), combined_plot_2, width = 16, height = 9, dpi = 600)
```
## Figure_3
